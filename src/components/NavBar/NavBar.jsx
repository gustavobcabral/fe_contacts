...
const NavBarMenu = (props) => (
  <Navbar collapseOnSelect expand="lg" bg="light" variant="light">
    <Navbar.Brand href="#home"><Image src={logo} width="50px" alt="Agenda" roundedCircle /></Navbar.Brand>
    ...
    <Navbar.Collapse id="responsive-navbar-nav">
      ...
      <Nav>
      <NavDropdown title={get("name", getUserData())} id="collasible-nav-dropdown">
